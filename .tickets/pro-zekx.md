...
Observed on the map tour (freedoom2 map02/map03, freedoom1 e1m1, head v3 trained on defend_the_center + map01 only): the bot empties its ammo into dead enemies and walks past health/ammo pickups. Trent: "we need to include more maps in the training ... but we also need holdback."
